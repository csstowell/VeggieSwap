...
app.config['MAIL_PASSWORD'] = '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'
app.config['MAIL_DEFAULT_SENDER'] = "charlottestowell@berkeley.edu"
mail = Mail(app)
